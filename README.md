...
```bash
pip install git+https://github.com/dev-baris/ai-stable-diffusion-tensorflow
```

### Installing using the repo

Download the repo, either by downloading the
[zip](https://github.com/dev-baris/ai-stable-diffusion-tensorflow/archive/refs/heads/master.zip)
file or by cloning the repo with git:

```bash
git clone git@github.com:dev-baris/ai-stable-diffusion-tensorflow.git
```
